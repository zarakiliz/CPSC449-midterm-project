...
def login():
    if request.method == 'GET':
        ...
        # For now, just print the username and password to verify form submission.
        username = request.form.get('username')
        password = request.form.get('password')

        # Simple response to confirm that the POST request works.
        return jsonify({'message': f'Received username: {username}, password: {password}'})
